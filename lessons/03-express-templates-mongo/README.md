...
## Exercises:
Check out [the homework readme](https://github.com/olinjs/olinjs/blob/master/lessons/03-express-templates-mongo/exercises.md) for an exercise to do before the next lesson.
